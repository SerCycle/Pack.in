...
@section('container')
    ...
    <p class="text-center font" style="margin-bottom : 30px; font-size: 25px;font-weight: bold;">Ingin Memantau Pesananmu?<a href="{{ route('CekPesanan') }}" class="font-italic" style="margin-left: 8px;">cek di sini</a></p>
